...
import gradientboxCorner from '../../public/img/repositorio_web-40.png';
        ...
        <div className={styles.breadcrumb}>
            <ul className={styles.breadcrumb}>
              ...
              <li className={styles.currentBreadcrumb}>
                {menuBreadcrumbs[0].label}
              </li>
            </ul>
        </div>
        <main className={styles.main}>
          <div className={styles.gradientboxContainer}>
            <div className={styles.gradientboxCorner}><Image src={gradientboxCorner} placeholder="blur" width='71' height='93'></Image></div>
            <div className={styles.gradientbox}><p className={styles.gradientboxtitle}>{guia[1].contenido[0].title}</p></div>
            <div className={styles.whitebox}><p className={styles.whiteboxtitle}>{guia[1].contenido[0].body}</p></div>
          </div>
